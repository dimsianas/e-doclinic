...
export default function DoctorsHomePage(){
    ...
    return(
        <div className="relative overflow-x-auto">
            <h1 className="text-3xl font-medium text-center mb-6 mr-12">Dashboard</h1>
            <p className="text-xl font-medium text-left mb-6">Appointments : {appointments.length}</p>
            <AppointmentsTable appointments={sortedAppointments} isDoctor={true} isDoctorHomePage={true}/>
        </div>
    );
}
